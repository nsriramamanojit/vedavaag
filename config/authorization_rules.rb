authorization do
  ...
  role :sa do
    has_permission_on [:users,:roles,:states,:districts,:projects], :to=>[:index,:new,:create,:show,:export,:profile,:profile_update,:update_profile,:change_password,:password_change]
  ...
  role :manager do
    has_permission_on [:users,:roles,:states,:districts,:projects], :to=>[:index,:new,:create,:show,:export,:profile,:profile_update,:update_profile,:change_password,:password_change]
    has_permission_on [:accounts], :to=>[:index,:new,:create,:show,:edit,:update,:export,:upload,:csv_import,:approve,:destroy]
    has_permission_on [:transactions], :to=>[:index,:new,:create,:show,:edit,:approve,:approve_pay,:update]
  end
